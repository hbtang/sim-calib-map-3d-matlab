...
syms q0_c_b q1_c_b q2_c_b q3_c_b
q_c_b = [q0_c_b; q1_c_b; q2_c_b; q3_c_b];
q_b_c = [-q0_c_b; q1_c_b; q2_c_b; q3_c_b];

R3_c_b = quat2rot(q_c_b);
R3_b_c = quat2rot(q_b_c);

syms x_c_b y_c_b z_c_b
t3_c_b = [x_c_b; y_c_b; z_c_b];
...
vec_sym = [q0_c_b q1_c_b q2_c_b q3_c_b ...
    x_c_b y_c_b ...
    x_b2_b1 y_b2_b1 theta_b2_b1 ...
    x_m_c1 y_m_c1 z_m_c1 ...
    x_m_c2 y_m_c2 z_m_c2
...
%% if pure translation...
% subs(J, [theta_b2_b1], 0)

%% substitution for true
% T3_b_c = simplify([R3_c_b.' -R3_c_b.'*t3_c_b; 0 0 0 1]);
% T3_b1_b2 = simplify([R3_b2_b1.' -R3_b2_b1.'*t3_b2_b1; 0 0 0 1]);
% 
% pt3_m_c2_mod = T3_b_c*T3_b1_b2*T3_c_b*[pt3_m_c1;1];
% pt3_m_c2_mod(4) = [];
% pt3_m_c2_mod = simplify(pt3_m_c2_mod)
% 
% J_true = subs(J, [x_m_c2; y_m_c2; z_m_c2], pt3_m_c2_mod);
% J_true = simplify(J_true)
