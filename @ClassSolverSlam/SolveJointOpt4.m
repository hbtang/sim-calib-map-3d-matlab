function SolveJointOpt4(this, measure, calib, map)

%% init
disp(['Start full temporal-spatio-odometric calibration with joint optimization...']);
...
disp('Full temporal-spatio-odometric calibration with joint optimization done!');
disp(' ');
