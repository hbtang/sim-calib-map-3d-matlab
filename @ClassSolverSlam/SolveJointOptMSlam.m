function SolveJointOptMSlam(this, measure, calib, map, options)
...
[q,resnorm,residual,exitflag,output,lambda,jacobian] = lsqnonlin(...
    @(x)CostJointOptMSlam(x, mk, odo, time, calib, this.setting, options), q, [], [], options_optim);
...
%% cost function
function [ vecCost, matJacobian ] = CostJointOptMSlam( q, mk, odo, time, calib, setting, options )
%COST
