function [ mat_jacobian, mat_jacobian_bc, mat_jacobian_wb, mat_jacobian_wm ] = Jacobian_Opt5Mk( ...
...
[ dR1, dR2, dR3 ] = DiffRotvec2Rotmat( rvec_b_c );
J1_r_c1 = dR1.'*(R3d_w_b.'*R3d_w_m*tvec_m_f + R3d_w_b.'*tvec_w_m - R3d_w_b.'*tvec_w_b-tvec_b_c);
J1_r_c2 = dR2.'*(R3d_w_b.'*R3d_w_m*tvec_m_f + R3d_w_b.'*tvec_w_m - R3d_w_b.'*tvec_w_b-tvec_b_c);
J1_r_c3 = dR3.'*(R3d_w_b.'*R3d_w_m*tvec_m_f + R3d_w_b.'*tvec_w_m - R3d_w_b.'*tvec_w_b-tvec_b_c);
J1_r = [J1_r_c1 J1_r_c2 J1_r_c3];
J1_t = -R3d_b_c.';
J1 = [J1_r J1_t];

% J2: jacobian of tvec_c_pt to [rvec_w_b; tvec_w_b]
[ dR1, dR2, dR3 ] = DiffRotvec2Rotmat( rvec_w_b );
J2_r_c1 = R3d_b_c.'*(dR1.')*(R3d_w_m*tvec_m_f + tvec_w_m - tvec_w_b);
J2_r_c2 = R3d_b_c.'*(dR2.')*(R3d_w_m*tvec_m_f + tvec_w_m - tvec_w_b);
J2_r_c3 = R3d_b_c.'*(dR3.')*(R3d_w_m*tvec_m_f + tvec_w_m - tvec_w_b);
J2_r = [J2_r_c1 J2_r_c2 J2_r_c3];
J2_t = -R3d_b_c.'*R3d_w_b.';
J2 = [J2_r J2_t];

% J3: jacobian of tvec_c_pt to [rvec_w_m; tvec_w_m]
[ dR1, dR2, dR3 ] = DiffRotvec2Rotmat( rvec_w_m );
J3_r_c1 = R3d_b_c.'*R3d_w_b.'*dR1*tvec_m_f;
J3_r_c2 = R3d_b_c.'*R3d_w_b.'*dR2*tvec_m_f;
J3_r_c3 = R3d_b_c.'*R3d_w_b.'*dR3*tvec_m_f;
J3_r = [J3_r_c1 J3_r_c2 J3_r_c3];
