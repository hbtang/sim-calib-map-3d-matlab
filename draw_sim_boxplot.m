...
%% init
PathFoldRes = 'C:\Workspace\Data\TRO\sim-ekfweak-odo1-mk1\';
% PathFoldRes = 'C:\Workspace\Data\TRO\sim-vm-odo1-mk1\';
...
title([MethodTitle, '. Res.: ', 'MkNs=', num2str(MkNs), '%, OdoNs', num2str(OdoNs), '%'],...
    'FontWeight', 'bold');
